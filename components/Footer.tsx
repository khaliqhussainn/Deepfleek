      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-white mb-4">DeepFleek</h3>
            <p className="text-gray-300 mb-4 max-w-md">
              Pioneering the future with cutting-edge technology solutions. 
              We transform ideas into reality through innovation and excellence.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link href="/home" className="block text-gray-300 hover:text-blue-400 transition-colors">
                Home
              </Link>
        ...
        <div className="border-t border-deep-blue-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 DeepFleek. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
