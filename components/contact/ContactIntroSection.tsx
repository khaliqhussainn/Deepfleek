      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }} // Always animate to visible state
          ...
          >
            <div className="mb-6">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                We're here to transform your ideas into reality. Our team of
                experts is ready to discuss your project and provide you with
            ...
            >
              <button className="group bg-blue-700 hover:bg-blue-800 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl">
              ...
              <div className="grid grid-cols-2 gap-6">
                {stats.map((stat, index) => (
                  <motion.div
                    ...
                    animate={{ opacity: 1, scale: 1 }} // Always animate to visible
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              From idea to implementation in 4 easy steps
            </p>
          </div>
            ...
            {[
              {
                step: "01",
                title: "Consultation",
                desc: "We discuss your needs and goals",
              },
              {
                step: "02",
                title: "Planning",
