  ...
  return (
    <section ref={ref} className="py-20 bg-slate-950 text-white">
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Get In Touch With Deepfleek</h2>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <motion.div
            ...
            className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl shadow-lg w-full md:w-1/2"
          >
            ...
            <form className="space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-lg font-medium text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                >
                  Send Message
                </button>
              </div>
          ...
          >
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-xl font-bold">Let's Meet Us</h4>
                  <p className="text-gray-300">
                    1608 Orilla, Madhya Street, Surataya, SB 9411a
                  </p>
                </div>
              </div>
              <div className="flex items-start">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-xl font-bold">Give us a call</h4>
                  <p className="text-gray-300">
                    Give us a ring at (+92) 1919 5434 896 every Monday - Friday from 9 am to 6 pm EST.
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Drop us an email at help@support.com and you'll receive a reply within 24 hours.
                  </p>
                </div>
              </div>
            </div>
