  ...
  const services: Service[] = [
    {
      ...
      description: "Modern web applications with React, Next.js, and TypeScript for exceptional performance.",
      features: ["React & Next.js", "TypeScript", "Responsive Design", "SEO Optimized", "Performance Tuned"],
      price: "$2,500",
    },
    {
      icon: Brain,
      title: "AI Integration",
      description: "Smart automation and machine learning solutions to transform your business processes.",
      features: ["Machine Learning", "Process Automation", "Data Analytics", "Custom AI Models", "Predictive Analysis"],
      price: "$4,000",
    },
    {
      icon: Smartphone,
      title: "Mobile Development",
      description: "Cross-platform mobile apps with native performance for iOS and Android platforms.",
    ...
    },
    {
      ...
      description: "Scalable cloud infrastructure with automated deployment and enterprise security.",
      features: ["AWS & Azure", "Auto Scaling", "DevOps Pipeline", "24/7 Monitoring", "Security First"],
      price: "$1,500"
    }
  ];
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            Solutions That
            <span className="block bg-gradient-to-r from-blue-400 via-blue-500 to-blue-300 bg-clip-text text-transparent">
              Drive Results
            </span>
          </h2>

          <p className="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
            Partner with industry experts to accelerate your digital transformation with proven methodologies and cutting-edge technology.
          </p>
        </div>
                  ...
                  <div className="space-y-2 mb-4">
                    {service.features.slice(0, 3).map((feature, idx) => (
                      <div
                        ...
                        style={{ transitionDelay: `${(index * 100) + (idx * 50) + 400}ms` }}
                      >
